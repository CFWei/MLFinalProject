...
def getDJI(date):
    try:
        ...
        url = "http://www.google.com/finance/historical?q=INDEXDJX%3A.DJI&ei=oWwmVKCtJYSTlAX03oGICg&startdate=" + startTime_m + "+" + startTime_d + "+" + startTime_y + "&enddate=" + endTime_m + "+" + endTime_d + "+" + endTime_y
